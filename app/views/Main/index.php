                ...
                <?php foreach ($brands as $brand): ?>
                    <div class="col-md-4 about-left">
                        <figure class="effect-bubba">
                            <img class="img-responsive" src="images/brands/<?= $brand->img; ?>" alt=""/>
                            <figcaption>
                                <h2><?= $brand->title; ?></h2>
                    ...
                    <?php foreach ($hits as $hit): ?>
                        <div class="col-md-3 product-left">
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <h4><a data-id="<?= $hit->id; ?>" class="add-to-cart-link" href="cart/add?id=<?= $hit->id; ?>"><i></i></a>
                                        ...
                                        <?php if ($hit->old_price): ?>
                                            <small>
                                                <?= $curr['simbol_left']; ?><del><?= floor($hit->old_price / $curr['value']); ?></del><?= $curr['simbol_right']; ?>
                                            </small>
                                        <?php endif; ?>
                                    </h4>
                                </div>
                                <div class="srch">
                                    <?php if ($hit->old_price): ?>
                                        <?php $discont = ($hit->old_price - $hit->price) / $hit['old_price'] * 100; ?>
